...
import Albums from '@/components/ui/menu/Albums.vue';
import Artists from '@/components/ui/menu/Artists.vue';
import LikedTracks from '@/components/ui/menu/LikedTracks.vue';
import Playlists from '@/components/ui/menu/Playlists.vue';
import TopListened from '@/components/ui/menu/TopListened.vue';
import { BUTTON_COLORS } from '@/components/ui/menu/config';
